...
class StoreController extends Controller{
    ...
    public function manage(Customers $customer, Stores $store){
        ...
        return view('admin.Store.managesettings', compact('store', 'features', 'customer'));
    }
    ...
    public function savePermissions(Request $request,Customers $customer, Stores $store){
        ...
        return redirect()->route('admin.customer.stores.manage', $store->uuid)
    ...
    public function activateStore($storeId){
        ...
        $store->activate();
        // Fire the event
        StoreActivated::dispatch($storeId);

        return response()->json(['message' => "Store {$storeId} activated successfully."]);
    ...
    public function deactivateStore($storeId){
        ...
        // Fire the event
        StoreDeactivated::dispatch($storeId);

        return response()->json(['message' => "Store {$storeId} deactivated successfully."]);
