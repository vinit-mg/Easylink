...
{
    public function getFeaturesForSubscription($subscription)
    {
        $package = $subscription->package; // Assuming a relationship exists between Subscription and Package
        ...
        foreach($features as $feature){
            ...
            if(!$subscription->ExtraLimits->isEmpty()){
                $extralimits = 0;
                $key = '';
                foreach($subscription->ExtraLimits as $ExtraLimit){
