...
$(document).ready(function () {
    $('#IsActive').change(function () {
        var url;
        var store_uuid = $(this).data('id');
        var customer_uuid = $(this).data('customerid');
        var status = false;
        ...
        if ($(this).is(':checked')) {
            switch($(this).data('for')){
                case "store":
                    url = route('admin.customer.stores.activate', [customer_uuid, store_uuid]) ;
                    break;
            }
        } else {
            switch($(this).data('for')){
                case "store":
                    url = route('admin.customer.stores.deactivate', [customer_uuid, store_uuid]) ;
                    break;
            }
        }
