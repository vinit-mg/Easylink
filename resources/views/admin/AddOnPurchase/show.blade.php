            ...
            <div class="card">
              <div class="card-body">
                    <div class="align-items-center card-title d-lg-flex d-md-block justify-content-between">
                        ...
                        <a class="btn btn-primary" href="{{route('admin.addonpurchase.index')}}"><i class="bi bi-arrow-left me-1"></i>{{__('Back to all addon purchase')}}</a>
                    </div> 
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                <td><strong>{{__('Subscription name')}}</strong></td>
                                <td>{{$addonpurchase->Customer_subscription->package->name}}</td>
                            </tr>
                            <tr>
