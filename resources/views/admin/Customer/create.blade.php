            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="POST" action="{{ route('admin.customers.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <input class="form-control" name="CompanyLogo" type="file" id="formFile">
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <label for="AccessURL" class="form-label">{{__('Website')}}</label>
                                <input type="text" name="AccessURL" class="form-control" id="AccessURL">
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <input type="text" name="CVR_no" class="form-control">
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
