            ...
            <div class="card">
              <div class="card-body">
                  <div class="align-items-center card-title d-lg-flex d-md-block justify-content-between">
                    <h5>{{__('Create email template')}}</h5>
                  ...
                  <form class="row g-3" method="POST" action="{{ route('admin.emailtemplates.store') }}">
                    @csrf
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <label for="TemplateName" class="form-label">Template Name</label>
                        <input type="text" class="form-control" name="TemplateName" id="TemplateName" fdprocessedid="wngp6">
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <label for="EmailSubject" class="form-label">Email Subject</label>
                        <input type="text" class="form-control" name="EmailSubject" id="EmailSubject" fdprocessedid="wngp6">
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <label for="EmailFrom" class="form-label">Email From</label>
                        <input type="email" class="form-control" name="EmailFrom" id="EmailFrom" fdprocessedid="wngp6">
                    </div>
                    <div class="col-12">
                        <!-- TinyMCE Editor -->
