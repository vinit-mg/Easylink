          ...
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                  ...
                  <form class="row g-3" method="POST" action="{{ route('admin.packages.store') }}">
                    @csrf
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="number" class="form-control" min="0" step="1.00" name="base_price_monthly">
                        </div>
                    </div>  
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="input-group mb-3">
                          <span class="input-group-text">Kr.</span>
                          <input type="number" class="form-control" min="0" step="1.00" name="base_price_yearly">
                        </div>
                    </div>
