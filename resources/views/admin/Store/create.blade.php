      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
              ...
              <form class="row g-3" method="POST" action="{{ route('admin.customer.stores.store', $customer->uuid) }}">
                @csrf
                      ...
                      <div class="col-sm-12">
                        ...
                        <select class="form-select" id="source" name="source">
                          ...
                          @foreach($sources as $source)
                            <option value="{{$source->id}}" data-desc= "{{$source->name}}">{{__($source->name)}}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        ...
                        <select class="form-select" id="destination" name="destination">
                          ...
                          @foreach($destinations as $destination)
                            <option value="{{$destination->id}}" data-desc= "{{$destination->name}}">{{__($destination->name)}}</option>
                          @endforeach
                        </select>
                    </div>
                    <div class="col-sm-12">
