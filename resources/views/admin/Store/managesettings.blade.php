					...
					<div class="card-body">
						...
						<nav>
							<div class="nav nav-tabs" id="nav-tab" role="tablist">
								...
								<button class="nav-link" id="supervisor_tab" data-bs-toggle="tab" data-bs-target="#supervisor" type="button" role="tab" aria-controls="supervisor" aria-selected="false">{{__('Supervisor')}}</button>
								<button class="nav-link" id="schedulers_tab" data-bs-toggle="tab" data-bs-target="#schedulers" type="button" role="tab" aria-controls="schedulers" aria-selected="false">{{__('Schedulers')}}</button>
							</div>
						</nav>
