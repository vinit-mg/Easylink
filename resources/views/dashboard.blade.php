                  ...
                  <div class="card-body">
                   <div class="align-items-center d-flex mt-3 pb-2">    
                    ...
                    <div class="align-items-center">
                      <div class="">
                        <select class="form-select" id="Customer" aria-label="Default select example">
                          <option>{{__('Select Customer')}}</option>
                          @foreach ($CustomerUsers as $CustomerUser)
                            <option value="{{$CustomerUser->Customer_id}}" {{$CurrentCustomer->id == $CustomerUser->Customer_id ? 'selected' : ''}}>{{$CustomerUser->Customer->CompanyName}}</option>
                          @endforeach
                        </select>
                        ...
                        <select class="form-select" id="store" aria-label="Default select example">
                            ...
                            @foreach ($CustomerUsers as $CustomerUser)
                                @foreach ($CustomerUser->Customer->stores as $store)
                                    <option value="{{$store->id}}" {{$CurrentStore->id == $store->id ? 'selected' : ''}}>{{$store->name}}</option>
                                @endforeach
