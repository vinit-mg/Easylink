...
Route::group([
    ...
    Route::resource('customer/{customer}/stores/{store}/scheduler', 'SchedulersController')->names([
        'show'    => 'customer.stores.scheduler.show',
        'edit'    => 'customer.stores.scheduler.edit',
        'update'  => 'customer.stores.scheduler.update',
    ]);
